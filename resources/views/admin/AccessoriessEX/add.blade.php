...
@section('title','اضافه اذن خروج اكسسوارت')

@section('pageHeader')
<i class="fa fa-money" aria-hidden="true"></i><span class="text-uppercase"> اضافه اذن خروج اكسسورات</span>
@endsection
  ...
  @endif
    ...
    <div class="tab-content">
        <div id="english1" class="tab-pane active in">
            <!-- form add user -->
            {!! Form::open(['route' => ['accessoriesex.store'], 'class' => 'form-transition add-transition']) !!}
                <div class="box-body">
                    @include('admin.AccessoriessEX.form')
                </div> <!-- /.box-body -->
