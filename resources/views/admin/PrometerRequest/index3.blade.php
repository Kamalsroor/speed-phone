  ...
  <div class="box">
    ...
    <div class="box-body">
      <table class="table table-bordered table-striped">
        ...
        <tbody>
            @foreach ($MobilatEx as $MobilatEnts)
            <tr>
            <td>{{ $MobilatEnts->Customersed->name }}</td>
            <td>{{ $MobilatEnts->created_at }}</td>
              
            <td>
                <a href="{{url('mobilatsex/'.$MobilatEnts->id)}}" class="btn btn-primary" data-toggle="tooltip" data-placement="top" title="Show Transition"><i class="fa fa-eye"></i></a>
                <a href="{{url('mobilatsex/'.$MobilatEnts->id.'/edit')}}" class="btn btn-success" data-toggle="tooltip" data-placement="top" title="Edit Transition"><i class="fa fa-edit"></i></a>
               
            @can('تعديل اذون اضافه تجاره')
               
               <a href="{{url('prometerfinsh/action/'.$MobilatEnts->id)}}" class="btn btn-success" data-toggle="tooltip" data-placement="top" title="Edit Account Type"><i class="fa fa-bolt"></i></a>
