        ...
        @foreach ($PrometerRequestsDetails as $details)
            <tr>
                <td>
                    ...
                    {!! Form::select('Prodact_name[]', $Mobilat, $details->Prodact_name, ['class' => ' form-control custom_select select2'   ]) !!}

                </td>
                
                <td>
                    {!! Form::text('Total[]', $details->qualityacc, ['class' => 'amount form-control', 'placeholder' => 'الكميه']) !!}
                    <div class="show-error-amount invalid-feedback"></div>
                </td>
