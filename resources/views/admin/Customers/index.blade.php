...
@section('body')
<br>
<a type="link" href="{{url('customers/create')}}" class="btn btn-primary btn-sm text-uppercase pull-right"><i class="fa fa-plus"></i> اضافه عميل جديد</a>
<br>
<br>
  <!-- Table -->
  <div class="box">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>{{$Customer->created_at}}</td>
                    ...
                    @can('admin')
                 @endcan
                        <a href="{{url('customers/'.$Customer->id.'/edit')}}" class="btn btn-success" data-toggle="tooltip" data-placement="top" title="Edit Account Type"><i class="fa fa-edit"></i></a>
                    </td>
            </tr>
            @endforeach
        </tbody>
