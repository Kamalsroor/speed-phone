  ...
  @endif
    ...
    <div class="tab-content">
      ...
      <div id="english1" class="tab-pane active in">
        ...
        {!! Form::open(['route' => ['prisess.update', $permission_ent_id], 'class' => 'form-transition edit-transition']) !!}
            @method('PUT')
            <div class="box-body">
                @include('admin.PermissionEntFreight.form_edit2')
            </div>
            <!-- /.box-body -->
...
@section('styles')
    {!! Html::style('public/admin/css/transition3.css') !!}
@endsection
@section('scripts')
