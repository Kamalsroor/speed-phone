...
@section('title','اذن تعديل اكسسوار')

@section('pageHeader')
<i class="fa fa-money" aria-hidden="true"></i><span class="text-uppercase"> اذن تعديل اكسسوار</span>
@endsection
  ...
  @endif
    ...
    <div class="tab-content">
      ...
      <div id="english1" class="tab-pane active in">
        ...
        {!! Form::open(['route' => ['accessoriesent.update', $MobilatEnt_id], 'class' => 'form-transition edit-transition']) !!}
            @method('PUT')
            <div class="box-body">
                @include('admin.AccessoriessEnt.form_edit')
            </div>
            <!-- /.box-body -->
