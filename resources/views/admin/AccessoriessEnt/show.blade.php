      ...
      <div class="box">
        <div class="box-header">
          <h3 class="box-title1">أذن صرف بضاعه </h3>
            ...
            <h3 class="box-title-Date"> <strong>   ألتاريخ :</strong>{{ money($permissionexfreight->PermissionDate) }}</h3>
           <strong class="title-name">يصرح يصرف بضاعه الي : </strong>  <h3 class="box-title-Name ">{{ $permissionexfreight->CustomerNames }}</h3>
            <br>
        </div>
        <!-- /.box-header -->
        <div class="box-body">
