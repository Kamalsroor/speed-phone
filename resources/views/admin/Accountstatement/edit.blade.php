...
<div class="box">
  ...
  <button type="button" class="close" data-dismiss="alert" aria-hidden="true">x</button>
   رؤيه <a href="{{url('account_types')}}">  الحسابات</a>.
  </div>
</div>
@endif
<!--./ success-->
  ...
  @endif
    ...
    <div class="tab-content">
      ...
      <div id="english1" class="tab-pane active in">
        ...
        {!! Form::model($AccountCustomers, ['route' => ['Accountstatement.update', $AccountCustomers->id]]) !!}
            @method('PUT')
            <div class="box-body">
                @include('admin.Accountstatement.form')
          </div>
          <!-- /.box-body -->
        </div>  <!-- /.english tab -->
