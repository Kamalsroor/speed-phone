...
@section('pageHeader')
<i class="fa fa-credit-card-alt" aria-hidden="true"></i><span class="text-uppercase"> Edit Account Type</span>
@endsection

@section('levelLinks')
<li><a href="{{curl('account_types')}}"><i class="fa fa-user"></i> Accounting Types</a></li>
<li class="active">Edit Account Type</li>
@endsection
@section('body')
<!-- success-->
  ...
  @endif
    ...
    <div class="tab-content">
      ...
      <div id="english1" class="tab-pane active in">
        ...
        {!! Form::model($account_type, ['route' => ['account_types.update', $account_type->id]]) !!}
            @method('PUT')
            <div class="box-body">
                @include('comp_user.account_types.form')
          </div>
          <!-- /.box-body -->
        </div>  <!-- /.english tab -->
