...
@section('pageHeader')
<i class="fa fa-money" aria-hidden="true"></i><span class="text-uppercase"> اذن خروج تجاره موبيلات</span>
@endsection
  ...
  @endif
    ...
    <div class="tab-content">
        <div id="english1" class="tab-pane active in">
            <!-- form add user -->
            {!! Form::open(['route' => ['mobilatsex.store'], 'class' => 'form-transition add-transition']) !!}
                <div class="box-body">
                    @include('admin.MobilatEx.form')
                </div> <!-- /.box-body -->
