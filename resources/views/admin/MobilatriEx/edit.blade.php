...
@section('title','تعديل اذن صرف تجاره')

@section('pageHeader')
<i class="fa fa-money" aria-hidden="true"></i><span class="text-uppercase">تعديل اذن صرف تجاره</span>
@endsection
  ...
  @endif
    ...
    <div class="tab-content">
      ...
      <div id="english1" class="tab-pane active in">
        ...
        {!! Form::open(['route' => ['prometer.update', $PrometerRequestsID], 'class' => 'form-transition edit-transition']) !!}
            @method('PUT')
            <div class="box-body">
                @include('admin.MobilatriEx.form_edit')
            </div>
            <!-- /.box-body -->
