...
@section('title','اضافه صنف جديد')

@section('pageHeader')
<i class="fa fa-credit-card-alt" aria-hidden="true"></i><span class="text-uppercase"> اضافه صنف موبيلات جديد</span>
@endsection
  ...
  @endif
    ...
    <div class="tab-content">
      ...
      <div id="english1" class="tab-pane active in">
        ...
        <!-- form add user -->
        {!! Form::open(['route' => ['mobilats.store']]) !!}
            <div class="box-body">
                @include('admin.mobilats.form')
          </div>
          <!-- /.box-body -->
        </div>  <!-- /.english tab -->
