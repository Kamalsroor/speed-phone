...
@section('title','حركه التوريد')

@section('pageHeader')
<i class="fa fa-credit-card-alt" aria-hidden="true"></i><span class="text-uppercase"> حركه التوريد</span>
@endsection
 ...
 <div class="box box-primary">
  ...
  <div class="box">
    ...
    <div class="box-header">
      ...
      <h3 class="box-title">حركه التوريد</h3>
    </div>
    <!-- /.box-header -->
    <div class="box-body">
...
$(document).ready(function(){
 ...
 {
  $.ajax({
   url:"{{ route('Searchent.actions') }}",
   method:'GET',
   data:{query:query},
   dataType:'json',
   success:function(data)
   {
    $('permission_ent_freight').html(data.table_data);
   }
  })
 }
