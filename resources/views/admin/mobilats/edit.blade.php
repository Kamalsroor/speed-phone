...
@section('pageHeader')
<i class="fa fa-credit-card-alt" aria-hidden="true"></i><span class="text-uppercase"> تعديل صنف موبيلات</span>
@endsection
  ...
  @endif
    ...
    <div class="tab-content">
      ...
      <div id="english1" class="tab-pane active in">
        ...
        {!! Form::model($mobilats, ['route' => ['mobilats.update', $mobilats->id]]) !!}
            @method('PUT')
            <div class="box-body">
